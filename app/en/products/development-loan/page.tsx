        ...
        <div className="max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-2xl">
          <div className="bg-gradient-to-br from-amber-100 to-amber-200 h-64 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-amber-800 font-medium">Add development site or construction image</p>
              <p className="text-sm text-amber-600">Path: /public/images/products/development-site.jpg</p>
            </div>
          </div>
        </div>
      </div>
