          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-md border hover:shadow-lg transition">
              ...
              <ul className="space-y-2 text-sm mb-8">
                ...
                <li>• Access to 100+ lenders and products</li>
                <li>• We handle all paperwork - save your time</li>
                <li>• Unbiased advice - always your best interest</li>
              </ul>
            ...
            <div className="bg-white p-8 rounded-xl shadow-md border hover:shadow-lg transition">
              ...
              <ul className="space-y-2 text-sm mb-8">
                ...
                <li>• 100+ lenders to choose from</li>
                <li>• Fast approval with dedicated support</li>
                <li>• Tailored to your cash flow needs</li>
              </ul>
            ...
            <div className="bg-white p-8 rounded-xl shadow-md border hover:shadow-lg transition">
              ...
              <ul className="space-y-2 text-sm mb-8">
                ...
                <li>• Access to specialist development lenders</li>
                <li>• Progress drawdowns, convert to permanent</li>
                <li>• Dedicated specialist, fast pre-approval</li>
              </ul>
