          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border text-center" style={{ borderColor: 'rgba(212, 168, 85, 0.2)', boxShadow: '0 4px 20px rgba(0,0,0,0.04)' }}>
              ...
              <div className="flex justify-center gap-4">
                <a href="#" className="w-10 h-10 rounded-full flex items-center justify-center transition-colors" style={{ background: 'rgba(212, 168, 85, 0.1)', color: '#d4a855' }} hover="bg-[#d4a855] hover:text-white">
