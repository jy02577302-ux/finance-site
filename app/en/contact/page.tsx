    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-3xl font-bold mb-6" style={{ color: '#1a1a1a', fontFamily: 'Playfair Display, serif' }}>Expert Team Ready to Serve You</h2>
          <p className="text-gray-600 leading-relaxed mb-8">
            Whether you need a home loan, business financing, or development funding, our licensed brokers are ready to provide free, professional advice. We are committed to transparency, efficiency, and putting our clients first.
          </p>
        ...
        <div className="grid lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white p-6 rounded-xl shadow-lg border" style={{ borderColor: 'rgba(212, 168, 85, 0.2)', boxShadow: '0 4px 20px rgba(0,0,0,0.04)' }}>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold mb-1" style={{ color: '#1a1a1a' }}>Email</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold mb-1" style={{ color: '#1a1a1a' }}>Address</h4>
            ...
            <div className="bg-gradient-to-br from-slate-50 to-white p-6 rounded-xl border" style={{ borderColor: 'rgba(212, 168, 85, 0.2)' }}>
              <h3 className="text-lg font-bold mb-4" style={{ color: '#1a1a1a' }}>Business Hours</h3>
              ...
              <p className="text-xs text-gray-500 mt-4">* Public holidays may vary</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border text-center" style={{ borderColor: 'rgba(212, 168, 85, 0.2)', boxShadow: '0 4px 20px rgba(0,0,0,0.04)' }}>
              <h3 className="text-lg font-bold mb-4" style={{ color: '#1a1a1a' }}>Follow Us</h3>
              <div className="flex justify-center gap-4">
                <a href="#" className="w-10 h-10 rounded-full flex items-center justify-center transition-colors hover:bg-[#d4a855] hover:text-white" style={{ background: 'rgba(212, 168, 85, 0.1)', color: '#d4a855' }}>
          ...
          <div className="lg:col-span-2">
            <div id="contact-form" className="bg-white rounded-xl shadow-lg border p-8" style={{ borderColor: 'rgba(212, 168, 85, 0.2)', boxShadow: '0 4px 20px rgba(0,0,0,0.04)' }}>
              <div className="mb-8">
                <h2 className="text-2xl font-bold mb-2" style={{ color: '#1a1a1a', fontFamily: 'Playfair Display, serif' }}>Send Us a Message</h2>
      ...
      <div className="py-16 mt-16" style={{ background: 'linear-gradient(135deg, #1a1a1a 0%, #2c2c2c 100%)' }}>
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold mb-4 text-white" style={{ fontFamily: 'Playfair Display, serif' }}>Ready to Get Started?</h2>
          <p className="text-white/80 mb-8 max-w-2xl mx-auto">
            Our expert team is ready to help you with free, professional mortgage advice. Contact us today and take the first step towards your property goals.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:0412892782"
